...
class MyRandomAccessStreamer(fast.PythonRandomAccessStreamer):
    ...
    def generateStream(self):
        ...
        while not self.isStopped():
            ...
            cv2.putText(image_array, label_text, (10, 80), cv2.FONT_HERSHEY_DUPLEX, 1.2, (173, 216, 230), 2)
...
run_streamer_with_label(full_video_path=
                        '/Users/miarodde/Documents/sintef/ebus-ai/EBUS_Levanger_full_videos/Patient_008/Sequence_001',
                        framerate=20, nr_of_frames=1586)
